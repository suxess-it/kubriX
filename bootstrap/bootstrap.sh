...
KUBRIX_CUSTOMER_GIT_USER_NAME=${KUBRIX_CUSTOMER_GIT_USER_NAME:-"dummy"}
...
echo "KUBRIX_CUSTOMER_GIT_USER_NAME: ${KUBRIX_CUSTOMER_GIT_USER_NAME}"
echo "-------------------------------------------------------------"
echo ""
...
gitUser: ${KUBRIX_CUSTOMER_GIT_USER_NAME}
EOF
