...
export TARGET_TYPE=KIND-PORTAL
...
nohup kubectl -n kargo port-forward svc/sx-backstage 6691:80 &
...
echo ""
echo "Backstage url: https://${CODESPACE_NAME}-6689.${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}"
