...
setup('authenticate', async ({ page }) => {
  await page.goto('https://grafana.127-0-0-1.nip.io/login?return_url=https%3A%2F%2Fargocd.127-0-0-1.nip.io%2Fapplications');
  ...
  await page.waitForURL('https://grafana.127-0-0-1.nip.io/applications');
